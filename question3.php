...
<form action=question3.php method=get style="font-family: Times New Roman;
font-size: 40;
color: black;
text-align: center;">
	...
	<br>
	<p>
	<input type=radio value='Mount Vesuvius' name=q3 style="width: 2em;
	height: 2em;">Mount Vesuvius
	<input type=radio value='Mauna Loa' name=q3 style="width: 2em;
	height: 2em;">Mauna Loa
