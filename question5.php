...
<form action=question5.php method=get style="font-family: Times New Roman;
font-size: 40;
color: black;
text-align: center;">
	...
	<br>
	<p>
	<input type=radio value='Asia' name=q5 style="width: 2em;
	height: 2em;">Asia
	<input type=radio value='Europe' name=q5 style="width: 2em;
	height: 2em;">Europe
